...
from Data_profiler.quality import require_columns, assert_non_empty, assert_unique_key
from Data_profiler.transforms import parse_datetime, add_time_parts, winsorize, add_outlier_flag
from Data_profiler.joins import safe_left_join
...
def main() -> None:
    ...
    out_path = p.processed / "analytics_table2.parquet"
